...
<div class="row">
	<div class="col-md-4 col-md-offset-3">
        ...
        <img src="assets/logo.png" alt="Logo" style="max-width: 25%; height: auto;">
      	</div>

		<center><h2 style="margin-top:1px;">Repository Of Faculty Activity Information System</h2></center>
